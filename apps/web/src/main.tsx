...
// index.html already applied these three inline, before the browser's first
// paint — this bundle is a deferred module and would otherwise run after
// the stylesheet had painted the light palette and the default Accent.
