...
it, immediately surfaces cases where UpNote itself is not a target worth copying. `docs/reference/upnote-macos-detail.md`
and `docs/reference/upnote-android-detail.md`'s own gap sweeps — driven against the shipped
